...
class Vector2 : public ::Vector2 {
  public:
    ...
    void DrawLine(::Vector2 endPos, float thick,
                  ::Color color = {0, 0, 0, 255}) const {
        ::DrawLineEx(*this, endPos, thick, color);
    }

    void DrawLineBezier(::Vector2 endPos, float thick,
                        ::Color color = {0, 0, 0, 255}) const {
    ...
    void DrawPoly(int sides, float radius, float rotation,
                  ::Color color = {0, 0, 0, 255}) const {
     ...
     */
    bool CheckCollisionCircle(float radius1, ::Vector2 center2,
                              float radius2) const {
     ...
     */
    bool CheckCollisionLines(::Vector2 endPos1, ::Vector2 startPos2,
                             ::Vector2 endPos2,
                             ::Vector2* collisionPoint) const {
        return ::CheckCollisionLines(*this, endPos1, startPos2, endPos2,
                                     collisionPoint);
    }
     ...
     */
    bool CheckCollisionPointLine(::Vector2 p1, ::Vector2 p2,
